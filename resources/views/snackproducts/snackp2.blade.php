...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <div class="card mt-4">
                <img class="card-img-top img-fluid" src="https://img13.360buyimg.com/n1/jfs/t1/973/23/9607/303561/5bac5ccaE6cd60300/6449aca6a0ff95bd.jpg" alt="">
                <div class="card-body">
                    <h3 class="card-title">天然手作零食-雞肉脆片100g</h3>
                    <h4>NTD 199</h4>
                    <p class="card-text">
                    <li>100%純天然肉品單一蛋白質</li>
                    <li>製造過程絕不添加任何添加物</li>
                    <li>堅持手工處理食材，去除多餘脂肪、碎骨頭、雜質</li>
                    <li>低溫烘焙鎖住養分，美味呈現！</li>
                    <li>適用於：犬、貓</li>
                    </p>
                    <p>
