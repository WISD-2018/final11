...
<head>
    ...
    <title>狗糧福利社-飼料-成犬7歲以上活力長壽配方 8kg(p4)</title>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <div class="card mt-4">
                <img class="card-img-top img-fluid" src="https://img4.momoshop.com.tw/goodsimg/0005/231/217/5231217_R.jpg?t=1511347880" alt="">
                <div class="card-body">
                    <h3 class="card-title">成犬7歲以上活力長壽配方 8kg</h3>
                    <h4>NTD 949</h4>
                    <p class="card-text">
                    <li>恢復年輕活力的營養</li>
                    <li>臨床實證抗氧化配方</li>
